...
{
    /*
    public class ALGraphRef<TVertex> : IGraph<TVertex>
        where TVertex : IComparable<TVertex>
    {
        ...
        public bool HasEdge(TVertex firstVertex, TVertex secondVertex)
        {
        ...
        {
            if (!HasVertex(vertex)) throw new KeyNotFoundException("Vertex does not belong to the graph!");
